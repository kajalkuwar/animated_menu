        ...
        body: Stack(
          children: <Widget>[
            AnimatedPositioned(
                ...
                child: _buildOption(
                    Icon(FontAwesome.picture_o, color: Colors.white),
                    Colors.purple)),
            AnimatedPositioned(
                duration: Duration(milliseconds: 300),
                left: opened
                ...
                ,
                child: _buildOption(Icon(FontAwesome.camera, color: Colors.white), Colors.amber)),
            AnimatedPositioned(
                duration: Duration(milliseconds: 300),
                left: opened
                    ? MediaQuery.of(context).size.width / 2 - 40.0
                ...
                top: (MediaQuery.of(context).size.height / 2) - 30.0,
                child: _buildOption(Icon(FontAwesome.clock_o, color: Colors.white), Colors.green)),
            AnimatedPositioned(
                duration: Duration(milliseconds: 300),
                left: opened
                    ? MediaQuery.of(context).size.width / 2 - 40.0
                ...
                (MediaQuery.of(context).size.height / 2) - 110.0
                ,
                child: _buildOption(Icon(FontAwesome.facebook, color: Colors.white), Colors.lightBlue)),
            AnimatedPositioned(
                duration: Duration(milliseconds: 300),
                ...
                child: _buildOption(Icon(FontAwesome.glass, color: Colors.white), Colors.brown)),
            AnimatedPositioned(
                duration: Duration(milliseconds: 300),
                left: MediaQuery.of(context).size.width / 2 - 35.0,
                top: opened
                ...
                child: _buildOption(Icon(FontAwesome.shopping_bag, color: Colors.white), Colors.pinkAccent)),
            AnimatedPositioned(
                duration: Duration(milliseconds: 300),
                ...
                child: _buildOption(Icon(FontAwesome.music, color: Colors.white), Colors.greenAccent)),
            AnimatedPositioned(
                duration: Duration(milliseconds: 300),
                left: opened ?MediaQuery.of(context).size.width / 2 - 40.0 :
                MediaQuery.of(context).size.width / 2 + 50.0
                ...
                top: opened
                    ? (MediaQuery.of(context).size.height / 2) - 40.0
                    : (MediaQuery.of(context).size.height / 2) + 50.0,
                child: _buildOption(Icon(FontAwesome.gamepad, color: Colors.white), Colors.grey)),
            Align(
